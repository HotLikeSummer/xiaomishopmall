<template>
	...
	<view id="salesService">
		...
		<view v-show="current==0">
			...
			<view class="Imei">
				<view class="con-imei">
					<input class="imei" type="text" placeholder="请输入IMEI或SN码" placeholder-style="color:#D1D1D1" />
					<input class="local-imei" type="text" placeholder="获取本机IMEI" placeholder-style="color:#D1D1D1" />
